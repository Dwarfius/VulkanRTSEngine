...
// TODO: need to get rid of tripple buffering and use double buffering for simplicity
...
private:
	...
	// TODO: Need to revisit this for proper implementation
	// Queues from Device
	struct QueuesInfo 
	{
	...
	vector<vk::ImageView> myImgViews; // views to access images through, needs to be destroyed
