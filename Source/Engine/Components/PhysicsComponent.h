...
public:
	...
	void CreateTriggerEntity(std::shared_ptr<PhysicsShapeBase> aShape, glm::vec3 anOrigin);
	void CreateOwnerlessTriggerEntity(std::shared_ptr<PhysicsShapeBase> aShape, const glm::mat4& aTransf);
