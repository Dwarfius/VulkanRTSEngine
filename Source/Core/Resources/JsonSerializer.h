...
class JsonSerializer : public Serializer
{
	...
	void SerializeImpl(std::string_view aName, const VecVariantType& aValue, const VariantType& aHint) override final;
	void DeserializeImpl(std::string_view aName, VariantType& aValue) override final;
	void DeserializeImpl(std::string_view aName, VecVariantType& aValue, const VariantType& aHint) override final;
